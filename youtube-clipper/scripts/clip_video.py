...
"""
Clip video segments
Use FFmpeg for precise video clipping while maintaining original quality
"""
...
def extract_subtitle_segment(
    ...
    """
    Extract subtitles for a specific time range from complete subtitles

    Args:
        subtitles: Complete subtitle list (each item contains {start, end, text})
...
def save_subtitles_as_srt(subtitles: list, output_path: str):
    ...
    with open(output_path, 'w', encoding='utf-8') as f:
        for i, sub in enumerate(subtitles, 1):
            ...
            # SRT timestamp (use comma for milliseconds)
