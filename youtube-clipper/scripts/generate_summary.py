...
Generate social media content based on chapter information
"""
...
def generate_summary(
    ...
    Claude will automatically handle content generation logic

    Args:
        chapter_info: Chapter information, including:
            - title: Chapter title
    ...
    # Output chapter info (for Claude to analyze)
    print("\n" + "="*60)
    ...
    print("="*60)
    print("""
Please generate social media content based on the chapter information above.

Content requirements:
1. Attractive title (10-20 words)
2. Core points (3-5 points, 1-2 sentences each)
3. Suitable platforms:
   - Twitter: Concise, with hashtags, 280 characters max
   - LinkedIn: Professional tone, detailed, no limit
   - YouTube description: SEO-friendly, includes timestamps
...
""")
    ...
    # Generate basic content (placeholder)
    summary_template = f"""# {chapter_info.get('title', 'Untitled Chapter')}
...
[Pending generation - Claude will auto-fill when Skill executes]
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("\nArguments:")
        print("  chapter_info_json - Chapter information JSON file path")
        print("  output_file       - Output file path (optional, default: summary.md)")
        ...
        print("  python generate_summary.py --create 'AGI Exponential Curve' '00:00-03:15' 'Core summary' 'AGI,growth,Claude' summary.md")
        sys.exit(1)
    ...
    try:
        ...
        print("   Claude will automatically generate detailed content")
